import { getCurrentDateFormatted, getCurrentMonthFormatted } from "../utils/fakerUtils";
...
export class AnnouncementPage extends AdminHomePage {
    ...
    public async dateFromTo(){
         ...
         await this.keyboardType(this.selectors.dateToInput, getCurrentMonthFormatted())
    }
